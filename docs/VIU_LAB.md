...
**Ручной import** (File→Import, не Commands): пока сессия `awaiting_rating`, кнопка **«Лаборатория»** не блокируется — только **скрин + vision + новый отчёт** (без полного цикла с шага 1). Оценку можно поставить потом.
