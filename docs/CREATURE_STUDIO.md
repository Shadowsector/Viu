...
### NSFW кости и мишени (панель Viu)

После канон-скелета (AccuRIG) в той же студии:

| Кнопка | Действие |
|--------|----------|
| **Всё NSFW сразу** | 6 Empty-мишеней + `Penis_01..03` (scale≈0) + `Vagina_L/R` |
| **Поставить 6 мишеней** | только `socket_*` |
| **Прикрутить penis** | только цепочка на Hips |
| **Кости вагины** | деформ, не aim |

Вью ставит по алиасам костей; расположение поправь глазами. «Сохранить эталон FBX» уносит сокеты вместе с арматурой.
