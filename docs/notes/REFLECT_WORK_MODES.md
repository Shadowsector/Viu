...
См. также: [`LIVING_VIU.md`](LIVING_VIU.md) — события, лор, сочинение/зёрна, сама пишет.
Режимы reflect/work **не дублируем** там длинно — этот файл про переключение мозга; жизнь и self-compose — в LIVING_VIU.
