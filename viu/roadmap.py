...
DEFAULT_MILESTONES: List[dict] = [
    ...
    {"id": 4, "title": "Walk + локомоция (A/D, Idle↔Walk)", "status": "in_progress",
     "note": "клипы в Animations/, параметр Speed, ShanyaLocomotion"},
    {"id": 5, "title": "Рост-референс: Шаня ~1.7 м в сцене", "status": "pending"},
