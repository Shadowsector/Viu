...
DEFAULT_MILESTONES: List[dict] = [
    ...
    {"id": 5, "title": "Рост-референс: Шаня ~1.7 м в сцене", "status": "done",
     "note": "масштаб персонажа, пол/сетка для ориентира"},
    {"id": 6, "title": "Тестовая сцена GameTest (пол, свет, камера)", "status": "done",
     "note": "пол, свет, камера следует за Шаней"},
    {"id": 7, "title": "Дом ~25 см на панели задач, прозрачная стена", "status": "in_progress",
     "note": "прототип: unity_overlay — полоса у таскбара, A/D"},
