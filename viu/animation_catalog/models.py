...
DEFAULT_WISHES: List[AnimationWish] = [
    ...
    _w(
        ...
        "rest",
        "Стоит на коленях",
        "Молитва, сбор с пола, интим-старт, перед all_fours.",
        "Оба колена на полу, корпус вертикальнее, чем all_fours.",
        "Hold / loop; Blender preset kneel.",
        ["Kneeling", "Kneel Idle"],
        wave=2,
    ...
    _w(
        ...
        "rest",
        "На четвереньках",
        "Интим / crawl / стыковка с партнёром через сокеты.",
        "Опоры руки+колени, спина параллельна полу.",
        "Hold; Blender preset all_fours. Партнёр — отдельный клип + IK.",
        ["All Fours", "On All Fours", "Crawl Idle"],
        wave=2,
        animator_state="AllFours",
        enters_from=["idle", "kneel"],
        exits_to=["idle", "kneel", "lie_down"],
    ),
    # --- rest ---
    _w(
        "sit_idle",
