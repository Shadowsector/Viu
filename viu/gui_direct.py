...
_RU_ALIASES: Dict[str, Tuple[str, Dict[str, Any]]] = {
    ...
    "бипеды канон": ("creature_biped_canon", {"action": "list"}),
    "очередь biped": ("creature_biped_canon", {"action": "queue"}),
    "перериг biped": ("creature_biped_canon", {"action": "guide"}),
    "ingest biped": ("creature_biped_canon", {"action": "ingest"}),
    "органы biped": ("creature_biped_canon", {"action": "mark_genital"}),
    "genital biped": ("creature_biped_canon", {"action": "mark_genital"}),
    "перериг просто": ("creature_biped_canon", {"action": "guide"}),
    "девки канон": ("creature_biped_canon", {"action": "list", "girls": "1"}),
