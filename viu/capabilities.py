...
Триггер: слово **Comfy** / **Комфи** (или ComfyUI). Тогда это пайплайн видео/MoCap, не фантазия «снять сцену».
Без этого слова «снять» может быть просто ролевая сцена — играй, не зови Comfy.
Не ври «нет доступа к камерам/Comfy». Reflect сам очередь не ставит.
Сейчас Comfy на паузе — сначала тело Шани (`body_pipeline`). Когда вернём — Студия Comfy / Lab.
